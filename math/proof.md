...
There is multiple method of proof

1. [[direct proof]]
2. [[proof by contradiction]]
3. [[proof by contraposition]]
4. [[proof by mathematical induction]]
5. [[element argument proof]]

## Writing advice

### 1. Copy the statement of the theorem to be proved

This makes the theorem [[statement]] available for reference to anyone reading
the proof

### 2. Clearly mark the beginning of your proof with the word Proof

This word separates general discussion about the theorem form its actual proof

### 3. Make your proof self-explained
...
Each assertion in a proof should come directly form the hypothesis of the
theorem or follow from the definition of one of the terms in the theorem or be a
result obtained earlier in the proof or be a mathematical result that has
previously been established or is agreed to be assumed

Indicate the reason for each step of your proof using phrases such as
"by hypothesis", "by definition of...by theorem"

### 7. Include the "little wors and phrases" that make the logic of your argument clear
...
Here is common mistakes when writting proof

#### 1. Using the same letter to mean two different things

We should not using the same letter / variables for two different thins

#### 2. Jumping to conclusion

To jump to a conclusion means to allege the truth of something without fiving an
adequate reason
